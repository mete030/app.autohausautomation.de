...
export function VoiceControl() {
  ...
  return (
    <>
      {successMessage && (
        <div className="fixed bottom-[var(--mobile-float-offset)] right-3 z-50 w-[min(360px,calc(100vw-1.25rem))] animate-in fade-in slide-in-from-bottom-4 duration-300 sm:right-6 sm:bottom-24 sm:max-w-sm">
